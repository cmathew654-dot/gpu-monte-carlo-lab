...
fn main( @location( 0 ) position : vec3<f32>,
	...
	v_positionView = vec4<f32>( ( nodeVar1.xy + ( mat2x2<f32>( nodeVar2, nodeVar3, ( - nodeVar3 ), nodeVar2 ) * ( ( position.xy - ( object.nodeUniform6 - vec2<f32>( 0.5 ) ) ) * ( vec2<f32>( length( object.nodeUniform4[ 0u ].xyz ), length( object.nodeUniform4[ 1u ].xyz ) ) * vec2<f32>( ( 0.17 * ( ( smoothstep( 0.96, 1.0, object.nodeUniform7 ) * 0.65 ) + 0.35 ) ) ) ) ) ) ), nodeVar1.zw );
